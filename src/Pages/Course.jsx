...
import filt from '../images/filt.png'
...
console.log("save data called");
  ...
  return (
    <>
      ...
      <div className="city-masters-container">
        <div className="header-section">
          <div className="combined">
            ...
            <div className="ac">
              <p>Access and manage comprehensive student details seamlessly. View personalized profiles tailored to your campus.</p>
            </div>
          </div>
        </div>
        <div className="button-group">
          <div className="firstbutton">
            <div className="logo">
              <img src={filt} alt="filter" className="filtericon" />
            </div>
            <div className="text">
              <p>Filter</p>
            </div>
          ...
          <div className="firstbutton">
            <div className="logo">
              <img src={expor} alt="filter" className="exporticon" />
            </div>
            <p>Export</p>
          </div>
          <div className="thirdbutton">
            <div className="logo">
              <img src={arrow} alt="filter" className="arrowicon" />
            </div>
            <p onClick={handleAddNewField}> Add New Field</p>
          </div>
